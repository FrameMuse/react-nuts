...
export function shuffle<T extends unknown[] = any>(...items: T) {
...
export function scrollIntoViewSmoothly(string: string, smooth: boolean = true): void {
    let element: HTMLElement | null = document.getElementById(string)
    if (element) {
...
export function CreateQuery<O extends (Object & { [x in any]: any }) = any>(queryObject: O): string {
